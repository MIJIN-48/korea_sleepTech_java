...
public class JavaTime {
	public static void main(String[] args) {
		...
		// .minus(Year, Months, Days): N년 전, N달 전, N일 전
		...
		System.out.println(now); // 11:12:51.643893800
		...
		System.out.println(restTime); // 11:50:14.499619300
		
		// cf) LocalDateTime 클래스
		//		: 날짜와 시간을 함께 다루는 클래스
		//		> .now(), .of(), .plus~(), .minus~() 사용 가능
		LocalDateTime nowDateTime = LocalDateTime.now();
		System.out.println(nowDateTime); // 2025-02-19T11:17:13.976629800
		...
		System.out.println(example); // 2025-02-19T11:24:39.637848100
		
		// DateTimeFormatter: LocalDateTime의 날짜/시간 데이터를 원하는 패턴으로 변경
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yy-MM-dd HH:mm:ss");
		System.out.println(example.format(formatter)); // 25-02-19 11:24:39
	}
}

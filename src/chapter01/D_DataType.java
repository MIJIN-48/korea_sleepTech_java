...
public class D_DataType {
	...
	public static void main(String[] args) {
		/*
		 * 데이터 타입(자료형, Data Type) : 자바는 '강'타입 언어 >> 모든 변수 선언 시 반드시! 데이터타입을 명시
		 * 
		 * 1. 데이터 타입 종류 1) 기본 타입 - 변수 선언 시 해당되는 자료형의 크기 만큼 메모리가 할당 - 실질적인 데이터가 저장
		 * 
		 * 2) 참조 타입 - 객체의 참조(메모리 주소)를 저장하는 변수 타입 - 객체, 배열과 같이 메모리의 Heap 영역에 저장된 데이터를 참조
		 */

...
// 1) @NoargsConstructror
// 2) @AllArgsConstuctor
// 3) @RequiredArgsConstructor

// 4. @Data 어노테이션
// : @Setter, @Getter, @ToString, @ReuquiredArgsConstructor, @EqualsAndHashCode 어노테이션을
//		한 번에 적용하는 어노테이션
...
@AllArgsConstructor // - title, author 모두를 매겨변수로 가짐

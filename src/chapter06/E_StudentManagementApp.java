...
class Student {
	...
	Student(int studenId, String name, int age, String major, double gpa) {
	...
	Student(int studenId, String name, int age) {
		this.studenId = studenId;
		this.name = name;
		this.age = age;
	}
...
public class E_StudentManagementApp {
...
//		Student student1 = new Student(1, "박미진", 30, "슬립테크", 4.0);
//		Student student2 = new Student(2, "홍길동", 20, "슬립테크", 4.2);
//		Student student3 = new Student(3, "홍길순", 32, "슬립테크", 3.5);
//		Student student4 = new Student(4, "아무개", 35, "슬립테크", 2.8);
//		
...
//		studentList.add(student4);
		...
		// 학생 추가
		addStudent(1, "박미진", 30, "슬립테크", 4.0);
		addStudent(2, "홍길동", 20, "슬립테크", 4.2);
		addStudent(3, "홍길순", 32, "슬립테크", 3.5);
		addStudent(4, "아무개", 35, "슬립테크", 2.8);
		
		// 학생 조회 (전체): 모든 학생 출력
		printAllStudent();
		
		// 학생 조회 (단건)
		System.out.println("== 학색 조회 (단건) ==");
		findStudentById(3);
		findStudentById(5);
		
		// 학생 평점 업데이트
		updateStudentGpa(1, 4.2);
